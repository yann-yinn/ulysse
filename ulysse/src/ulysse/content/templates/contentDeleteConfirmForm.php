<div class="panel radius">
  <form method="POST" action="<?php echo path("ulysse.content.delete", 'form_redirection=' . getFormRedirectionFromUrl()) ?>">
    ...
    <div class="text-center">
      <a class="button radius success" href="<?php e(path($_GET['form_redirection'])) ?>">
