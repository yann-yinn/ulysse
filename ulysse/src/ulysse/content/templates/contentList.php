    ...
    <table>
      ...
      <?php foreach ($datas as $data): ?>
        <tr>
          ...
          <td><a href="<?php e(path("ulysse.content.edit", 'machine_name=' . $data['machine_name'] . '&form_redirection=ulysse.content.list')) ?>">Edit</a></td>
          <?php if ($state == CONTENT_STATE_TRASH) : ?>
            <td><a href="<?php e(path("ulysse.content.confirmDeletion", 'machine_name=' . $data['machine_name'] . '&form_redirection=ulysse.content.list')) ?>">Delete</a></td>
          <?php endif ?>
